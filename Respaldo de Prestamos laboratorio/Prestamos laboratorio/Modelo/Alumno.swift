...
class Estudiante {
    ...
    func guardarInfoAlumno(numeroCuenta: String, apellidoPaterno: String, apellidoMaterno: String, nombre: String, facultad: String, carrera: String, asignatura: String, grupo: Int) {
