...
//Componentes de la collection - Seccion, grupo, item
import UIKit

private let reuseIdentifier = "Cell"
private let items = ["Nuevo León", "Yucatán", "Edo. México", "Baja California", "Ciudad de México", "Jalisco", "Quintana Roo", "Puebla", "Nayarit", "Sinaloa", "Tamaulipas", "Sonora"]
...
class BasicCollectionViewController: UICollectionViewController {
    ...
    //En absolute se especifican los puntos
    //En fractional se especifica el porcentaje
